...
module.exports = schemakit;

/**
 * validateSpecific() checks if the property/values included in data pass the schema
...
/**
 * validate() does the same thing as validateSpecific() but returns errors if
...
function validate(schema, data, done) {
  ...
  this.validateSpecific(schema, data, function(err, res) {
